...
[Type(type : typeof(@enumName), speractors : new string[] { ""@enumName"" })]
 public class @enumNameType : IType{
...
";
        public EnumGenerator(string enumName, System.Action<string> onGenerateCallback = null)
        {
        ...
        { 
            var result = Def.Replace("@enumName", enumName);
