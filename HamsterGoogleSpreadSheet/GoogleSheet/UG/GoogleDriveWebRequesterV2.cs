...
public class GoogleDriveWebRequesterV2 : IHttpProtcol
{
    ...
    public void WriteObject(WriteObjectReqModel mdl, Action<Exception> errResponse, Action<GoogleSheet.Protocol.v2.Res.WriteObjectResult> callback)
    { 
    ...
    public void CopyFolder(CopyFolderReqModel mdl, Action<Exception> errResponse, Action<CreateExampleResult> callback)
    {
